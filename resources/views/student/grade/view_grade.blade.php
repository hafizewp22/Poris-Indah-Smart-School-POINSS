<div class="">
    ...
    <!-- List -->
    <div class="h-[25.5rem] overflow-y-scroll scrollbar">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                @forelse($subject as $data)
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        @else
                            <th scope="row" class="py-4 px-6 text-[#00AB41] dark:text-white">
                                Passed
                            </th>
                        @endif
                    </tr>
                @empty
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        <td colspan="7" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            No Data
                        </td>
                    </tr>
                @endforelse
