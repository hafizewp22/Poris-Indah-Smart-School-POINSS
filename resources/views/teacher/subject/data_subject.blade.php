...
@section('content')
    ...
    <div>
        <form class="flex justify-between" method="GET" action="{{route('search.teacher.subject')}}">
            <div class="flex">
                ...
                @foreach($dataSubjects as $data)
                    <div
                        ...
                        <div class="mt-3 flex justify-between">
                            <a href="{{route('view.class.teacher.subject', $data->id_sub)}}" class="place-items-center space-x-4 focus:outline-none text-black-50 bg-white hover:bg-white font-medium rounded-lg text-sm px-3 py-2.5 space-x-4 " >View</a>
                            <a href="{{route('view.class.teacher.subject.student', $data->id_sub)}}" class="place-items-center space-x-4 focus:outline-none text-black-50 bg-white hover:bg-white font-medium rounded-lg text-sm px-3 py-2.5 space-x-4 " >Data Student</a>
                        </div>
                    </div>
                @endforeach
            </div>
