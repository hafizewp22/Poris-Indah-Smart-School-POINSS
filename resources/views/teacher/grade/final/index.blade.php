            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                @forelse($userSubjectUpdate as $data)
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <th scope="row" class="py-4 px-6 text-gray-900 dark:text-white">
                            <a href="{{route('view.teacher.grade', $data->id_grade)}}" class="focus:outline-none text-white bg-[#464867] hover:bg-[#464867] font-medium rounded-lg text-sm px-5 py-2.5 mb-2 " type="button">View Data</a>
                        </th>
                    </tr>
