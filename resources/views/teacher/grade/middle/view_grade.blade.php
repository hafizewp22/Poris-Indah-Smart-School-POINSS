        ...
        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                @if($userGrades->done == '1')
                    <div class="box-border h-12 w-64 p-2 rounded-lg bg-[#FFAA06]">
                        <a href="{{route('file.middle.view.teacher.grade', $userGrades->id_grade)}}" class="flex" >
                    ...
                    <h1 class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">Min Exam Data for this class has been entered.</h1>
