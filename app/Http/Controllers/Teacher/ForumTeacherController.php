...
class ForumTeacherController extends Controller
{
    public function DataForum(){
        ...
        return view('teacher.forum.data_forum', compact('userSubject', 'userForum', 'userClass'));
    }
    ...
    public function EditForum($id){
        ...
        return view('teacher.forum.data_forum', compact('userSubject', 'userForum', 'forums'));
    }
    ...
    public function ViewForum($id){
        ...
        return view('teacher.forum.view_forum', compact( 'forums', 'forumDetails'));
    }
