...
@section('content')
    ...
    <form class="flex justify-between" method="GET" action="{{route('search.student.forum')}}">
        <div class="flex">
    ...
    <div>
        <div class="pt-6 pb-6 lg:h-96 xl:h-[29rem] overflow-y-scroll scrollbar">
            @foreach($userForum as $data)
                    ...
                    <div class="box-border h-25 pt-6 rounded-lg pt-2 pb-2  p-4 bg-[#464867]">
                        <div class="flex justify-between">
                            ...
                            <div class="pr-4 flex flex-wrap -mx-3 place-items-center space-x-4 ">
                                <a href="{{route('view.student.forum', $data->id_forum)}}">
                                ...
                                @if($data->id_user_full == Auth::user()->id)
                                    <a data-modal-toggle="popup-modal-{{route('model.delete.student.forum', $data->id_forum)}}" type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8  text-white" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>

                                    <a type="button" data-modal-toggle="edit-{{route('edit.student.forum', $data->id_forum)}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8  text-white" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                        </svg>
                                    </a>

                                    <div id="popup-modal-{{route('model.delete.student.forum', $data->id_forum)}}" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                        <div class="relative w-full h-full max-w-md md:h-auto">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                <div class="p-6 text-center">
                                                    ...
                                                    <a  href="{{ route('delete.student.forum', $data->id_forum) }}" type="button" class="text-white bg-red-800 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                                        Yes, I'm sure
                                                    </a>
                                                    <button data-modal-toggle="popup-modal-{{route('model.delete.student.forum', $data->id_forum)}}" type="button" class="text-white bg-[#464867] hover:bg-[#464867] focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No, cancel</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div id="edit-{{route('edit.student.forum', $data->id_forum)}}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                        <!-- Modal content -->
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="edit-{{route('edit.student.forum', $data->id_forum)}}">
                            ...
                            <div class="py-6 px-6 lg:px-8">
                                ...
                                <form class="space-y-6" method="POST" action="{{route('update.student.forum')}}" enctype="multipart/form-data">
                                    @csrf
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" method="POST" action="{{route('add.student.forum')}}" enctype="multipart/form-data">
                        @csrf
                        <div>
