...
@section('content')
    ...
    <div class="flex">
        ...
        <h3 class="p-2 mb-2 text-2xl font-bold text-gray-900 dark:text-white">Input Grade</h3>
    </div>
    ...
    <div class="pt-6 pb-6 lg:h-96 xl:h-[34rem] overflow-y-scroll scrollbar">
        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
            <form method="POST" action="{{route('add.teacher.grade')}}" enctype="multipart/form-data">
                @csrf
                    ...
                    @forelse($subject as $data)
                        ...
                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <input
                                ...
                                autocomplete="total"
                                class="form-group bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                required
                            >
                        </tr>
                    @empty
