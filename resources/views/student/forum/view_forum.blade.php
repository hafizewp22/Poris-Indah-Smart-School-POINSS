...
@section('content')
    ...
    <div class="flex">
        ...
        <a href="{{url('student/forum')}}" class="text-2xl font-bold text-[#464867] dark:text-white hover:text-[#464867]">
    ...
    <div class="pt-6 pb-6 lg:h-96 xl:h-[34rem] overflow-y-scroll scrollbar">
                ...
                <div class="flex justify-between">
                    <div>
                        <div class="break-all space-y-2 pl-5">
                            ...
                            <h1 class="ml-2 text-sm font-medium text-black dark:text-black text-black">{{$forums->description}}</h1>
                            <br />
                            <div>
        ...
        @foreach($forumDetails as $data)
                            ...
                            <div class="break-all space-y-2 pl-5">
                                ...
                                @if($data->id_user_full1 == Auth::user()->id)
                                    <div class="ml-2 flex flex-wrap place-items-center space-x-4">
                                        <a type="button" data-modal-toggle="edit-{{route('edit.student.forum.detail', $data->id_forum_detail)}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8  text-black" viewBox="0 0 20 20" fill="currentColor">
                                                <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                            </svg>
                                        </a>

                                        <a data-modal-toggle="popup-modal-{{route('model.delete.student.forum.detail', $data->id_forum_detail)}}" type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8  text-black" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div id="popup-modal-{{route('model.delete.student.forum.detail', $data->id_forum_detail)}}" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                <div class="relative w-full h-full max-w-md md:h-auto">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="p-6 text-center">
                            ...
                            <a  href="{{ route('delete.student.forum.detail', $data->id_forum_detail) }}" type="button" class="text-white bg-red-800 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                Yes, I'm sure
                            </a>
                            <button data-modal-toggle="popup-modal-{{route('model.delete.student.forum.detail', $data->id_forum_detail)}}" type="button" class="text-white bg-[#464867] hover:bg-[#464867] focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No, cancel</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="edit-{{route('edit.student.forum.detail', $data->id_forum_detail)}}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="edit-{{route('edit.student.forum.detail', $data->id_forum_detail)}}">
                        ...
                        <div class="py-6 px-6 lg:px-8">
                            ...
                            <form class="space-y-6" method="POST" action="{{route('update.student.forum.detail')}}" enctype="multipart/form-data">
                                @csrf
        ...
        <div class="relative w-full max-w-7xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" method="POST" action="{{route('add.student.forum.detail')}}" enctype="multipart/form-data">
                        @csrf
                        <input
                            type="hidden"
                            name="id_forum"
